...
// New Added
// router.put("/api/change-password", validateToken, changePassword);
// router.get('/search-product-for-name/:nameProduct', validateToken, searchProductForName );
// router.get('/search-product-for-category/:idCategory', validateToken, searchProductsForCategory );
// router.post('/login-email-id', login.loginController);
// router.get('/renew-token-login', validateToken, login.renewTokenLogin);
// -------------------

...
class _ListProducts extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final courseBloc = BlocProvider.of<CoBloc>(context);
    return FutureBuilder<List<Co>>(
      future: dbHomeController.getListCosHome(),
      builder: (context, snapshot) {
        List<Co> list = snapshot.data;
                                ...
                                Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      ...
                                      courseBloc.add(AddCourseToCart(
                                          course: Courseselect));

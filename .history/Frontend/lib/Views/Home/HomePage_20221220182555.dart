                              ...
                              children: [
                                Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      modalAddCartSuccess(
                                          context, roduct.picture);

                                      // ignore: non_constant_identifier_names
                                      final Productselect = ProductCart(
                                          uidProduct: roduct.id,
                                          image: roduct.picture,
                                          name: roduct.nameProduct,
                                          price: roduct.price.toDouble(),
                                          amount: 1);

                                      roductBloc.add(AddProductToCart(
                                          roduct: Productselect));

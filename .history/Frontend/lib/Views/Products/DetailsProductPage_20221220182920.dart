...
class DetailsProductPage extends StatelessWidget {
  final Product cou;
  DetailsCoursePage({@required this.cou});

  @override
  Widget build(BuildContext context) {
    final couBloc = BlocProvider.of<ProductBloc>(context);
    return Scaffold(
        ...
        child: Stack(
          children: [
            ListView(
              ...
              children: [
                _AppBarCourse(
                    nameCourse: cou.nameCourse, uidCourse: cou.id),
                SizedBox(height: 5.0),
                _ImageCourse(uidCourse: cou.id, imageCourse: cou.picture),

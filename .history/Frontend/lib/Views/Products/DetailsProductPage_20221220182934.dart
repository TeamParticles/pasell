...
class DetailsProductPage extends StatelessWidget {
  ...
  DetailsCoursePage({@required this.Product});
        ...
        child: Stack(
          children: [
            ListView(
              ...
              children: [
                _AppBarCourse(
                    nameCourse: Product.nameCourse, uidCourse: Product.id),
                SizedBox(height: 5.0),
                _ImageCourse(uidCourse: Product.id, imageCourse: Product.picture),

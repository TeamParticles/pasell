...
class DetailsProductPage extends StatelessWidget {
  final Product co;
  DetailsCoursePage({@required this.co});

  @override
  Widget build(BuildContext context) {
    final coBloc = BlocProvider.of<ProductBloc>(context);
    return Scaffold(
        ...
        child: Stack(
          children: [
            ListView(
              ...
              children: [
                _AppBarCourse(
                    nameCourse: co.nameCourse, uidCourse: co.id),
                SizedBox(height: 5.0),
                _ImageCourse(uidCourse: co.id, imageCourse: co.picture),

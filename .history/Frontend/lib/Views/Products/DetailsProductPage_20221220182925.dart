...
class DetailsProductPage extends StatelessWidget {
  final Product c;
  DetailsCoursePage({@required this.c});

  @override
  Widget build(BuildContext context) {
    final cBloc = BlocProvider.of<ProductBloc>(context);
    return Scaffold(
        ...
        child: Stack(
          children: [
            ListView(
              ...
              children: [
                _AppBarCourse(
                    nameCourse: c.nameCourse, uidCourse: c.id),
                SizedBox(height: 5.0),
                _ImageCourse(uidCourse: c.id, imageCourse: c.picture),

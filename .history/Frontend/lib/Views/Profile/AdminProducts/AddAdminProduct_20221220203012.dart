...
class _AddAdminProductstate extends State<AddAdminProduct> {
  ...
  Widget build(BuildContext context) {
    final adminCourseBloc = BlocProvider.of<AdminProductBloc>(context);
    ...
    return BlocListener<AdminProductBloc, AdminProductstate>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            ...
            elevation: 0,
            title: CustomText(
                text: isUpdate ? "Update ${product.nameProduct}" : 'Add Product',
                color: Colors.black),
            centerTitle: true,
            leading: IconButton(
              icon: Icon(
          ...
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                initialValue: product.codeCourse,
                keyboardType: TextInputType.number,
                onChanged: (value) => Product.codeCourse = value,
                validator: (value) {
                  if (value.isEmpty) {

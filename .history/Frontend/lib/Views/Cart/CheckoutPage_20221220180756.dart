...
import '../../Helpers/modalPayment.dart';
...
class _CheckOutPagePageState extends State<CheckOutPagePage> {
  ...
  Future<void> makePayment(double amount) async {
    try {
      ...
      await Stripe.instance.initPaymentSheet(
        ...
        merchantDisplayName: "Aims Digital ",
      ));
  ...
  Widget build(BuildContext context) {
    ...
    final roductBloc = BlocProvider.of<CourseBloc>(context);
    ...
    return BlocListener<CartBloc, CartState>(
      listener: (context, state) {
        if (state is LoadingPaymentState) {
          ...
          roductBloc.add(SaveCoursesBuy(
              date: DateTime.now().toString(),
              amount: '${roductBloc.state.total}',
              roduct: roductBloc.roduct));
          roductBloc.add(ClearCoursesEvent());
          ...
          children: [
            ...
            Container(
              ...
              child: CustomButton(
                ...
                fontSize: 22,
                onPressed: () async {
                  // await makePayment(CourseBloc.state.total * 100);
                  // await Stripe.instance.presentPaymentSheet();
                  cartBloc.add(
                    OnMakePayment(amount: courseBloc.state.total * 100),
                  );
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              CustomText(
                text: '\$ ${courseBloc.state.delivery}',
                fontSize: 19,
              )
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              CustomText(
                text: '\$ ${courseBloc.state.insurance}',
                fontSize: 19,
              )
            ],
          ),

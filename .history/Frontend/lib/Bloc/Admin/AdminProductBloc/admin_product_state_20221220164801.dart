...
// --------------------------------------------------//
class AddCoursstate extends AdminProductstate {}

class LoadingAddCoursstate extends AdminProductstate {}

class AddCourssuccessState extends AdminProductstate {}

class FailureAddCoursstate extends AdminProductstate {
  final String error;

  FailureAddCoursstate({this.error});
}

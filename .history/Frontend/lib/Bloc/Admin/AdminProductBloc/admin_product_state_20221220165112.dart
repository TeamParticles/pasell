...
// --------------- delete state -------------------
class DeleteCLoadingState extends AdminProductstate {}

class DeleteCsuccessState extends AdminProductstate {}

class DeleteCFailureState extends AdminProductstate {
  final String error;

  DeleteCFailureState({this.error});
}

...
// --------------------------------------------------//
class Addstate extends AdminProductstate {}

class LoadingAddstate extends AdminProductstate {}

class AddsuccessState extends AdminProductstate {}

class FailureAddstate extends AdminProductstate {
  final String error;

  FailureAddstate({this.error});
}

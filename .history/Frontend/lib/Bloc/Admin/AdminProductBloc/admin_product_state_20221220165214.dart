...
class GetByIdLoadingState extends AdminProductstate {}

class GetByIdSuccessState extends AdminProductstate {}

class GetByIdFailureState extends AdminProductstate {
  final String error;

  GetByIdFailureState({this.error});
}

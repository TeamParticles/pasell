...
class AdminProductBloc extends Bloc<AdminProductEvent, AdminCoursestate> {
  AdminProductBloc() : super(AdminCoursestate());

  @override
  Stream<AdminCoursestate> mapEventToState(AdminProductEvent event) async* {

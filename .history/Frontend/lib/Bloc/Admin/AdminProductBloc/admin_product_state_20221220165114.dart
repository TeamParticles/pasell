...
// --------------- delete state -------------------
class DeleteLoadingState extends AdminProductstate {}

class DeletesuccessState extends AdminProductstate {}

class DeleteFailureState extends AdminProductstate {
  final String error;

  DeleteFailureState({this.error});
}

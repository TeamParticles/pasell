...
sHome coursesHomeFromJson(String str) =>
    sHome.fromJson(json.decode(str));

String coursesHomeToJson(sHome data) => json.encode(data.toJson());
...
class sHome {
  ...
  factory CoursesHome.fromJson(Map<String, dynamic> json) {
    return CoursesHome(
      resp: json["resp"],
      msj: json["msj"],
      products: List<Course>.from(json["products"].map((x) {

...
PurchasedProductsResponse purchasedProductsResponseFromJson(String str) =>
    PurchasedProductsResponse.fromJson(json.decode(str));

String purchasedProductsResponseToJson(PurchasedProductsResponse data) =>
...
class PurchasedProductsResponse {
  ...
  factory PurchasedProductsResponse.fromJson(Map<String, dynamic> json) =>
      PurchasedProductsResponse(
        resp: json["resp"],
        msg: json["msg"],

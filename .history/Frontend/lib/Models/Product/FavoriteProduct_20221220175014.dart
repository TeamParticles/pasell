...
class FavoriteProduct {
  ...
  factory FavoriteProduct.fromJson(Map<String, dynamic> json) {
    print("This is Favorite Product map $json");

    var favCourse = FavoriteProduct(
      resp: json["resp"],
      msj: json["msj"],
      favorites: List<Favorite>.from(
          json["favorites"].map((x) => Favorite.fromJson(x))),
    );
    print("This is fav Product $favCourse");
    return favCourse;
  }
...
class CourseId {
  ...
  factory CourseId.fromJson(Map<String, dynamic> json) {
    print("This is Product map $json");
    var product = CourseId(
      status: json["status"],
      id: json["_id"],

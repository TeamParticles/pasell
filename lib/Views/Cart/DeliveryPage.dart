...
class _DeliveryPageState extends State<DeliveryPage> {
  ...
  getPersonalInformation() async {
    ...
    BlocProvider.of<PersonalBloc>(context).add(GetStreetAddress(
        address: info.information.address,
        reference: info.information.reference));
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PersonalBloc, PersonalState>(
      listener: (context, state) {
        if (state is LoadingPersonalState) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: CustomText(text: 'Error adding Street Address'),
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: CustomText(text: 'Address', color: Colors.black, fontSize: 21),
          centerTitle: true,
          elevation: 0,
          leading: IconButton(
            ...
            children: [
              ...
              Container(
                  ...
                  child: CustomButton(
                    ...
                    height: 55,
                    fontSize: 19,
                    onPressed: () => personalBloc.add(AddStreetAddress(

...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  Stream<ProductState> mapEventAddOrDeleteProductFavorite(
    ...
    try {
      final resp = await dbProductController.addOrDeleteProductFavorite(
...
class Loadcart extends ProductEvent {}

class Loadedcart extends ProductEvent {}

class Failcart extends ProductEvent {}
